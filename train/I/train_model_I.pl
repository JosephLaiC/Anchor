...
while($i<$num_cell){
    ...
    # Copy the train and test data files to the current directory
    ...
    # Cut the first field of the test data file and save it to a new file
    ...
    foreach $model (@all_config){
        ...
        # Move the AUC and AUPRC results to the current model directory
    ...
    # Move the trained models and evaluation results to the current directory
